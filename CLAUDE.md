...
| `WavefrontRefractionTest.jsx` | Wavefront Refraction (v0.2.6) — two-stage objective wavefront + subjective liquid-lens phoropter; supersedes but does NOT replace Aberrometry (both stay in catalog) |
