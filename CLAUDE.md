...
| 04 | Visual Fields | `VisualFieldTest.jsx` standalone | ⬜ needs design pass review |
| 05 | Wavefront Aberrometry | extract from `RemainingTests.jsx` → `WavefrontAberrometryTest.jsx` | ⬜ needs extraction + WFA_ prefixes + design pass |
