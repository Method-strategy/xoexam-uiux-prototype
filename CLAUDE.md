...
| 06 | Ocular Motility | extract from `MotilityAndNeuro.jsx` → `OcularMotilityTest.jsx` | ⬜ v0.2.1 · needs assessment + extraction |
| 07 | Pupillometry | `PupillometryTest.jsx` standalone | ⬜ v0.2.2 · needs assessment + ExamShell refactor |
