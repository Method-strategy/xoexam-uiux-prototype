...
## 0. What changed in v0.2.8 — accurate change log
...
## 8. Document set issued at v0.2.8

| Document | Status |
|---|---|
| `xoExam UI-UX Engineering Handoff Specification v0.2.8.docx` | **This document** — supersedes v0.2.7 |
| `xoExam Development Brief 06-09-2026 v0.2.8.docx` | New per-release brief (v0.2.8) |
...
*Method Marketing Agency · xoExam UI/UX Engineering Handoff Specification · v0.2.8 · June 9, 2026*
